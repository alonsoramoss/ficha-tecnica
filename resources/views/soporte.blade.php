...
@section("content")
    <div class="container">
        <form id="formFicha" name="formFicha" action="{{ route("guardar") }}" method="POST" class="p-4 p-md-5 border shadow-lg">
            @csrf
            <div class="row mb-4">
                <div class="d-flex justify-content-center col-12 col-md-4 mb-3">
                    <img src="{{ asset("img/municipalidad-pisco.png") }}" alt="Municipalidad de Pisco" class="img-fluid" style="width: 19rem;">
                </div>
            ...
            <h5 class="fw-semibold mb-3 text-center text-md-start">INFORMACIÓN GENERAL</h5>
            ...
            <h5 class="fw-semibold text-center text-md-start">CONSTANCIA DE ATENCIÓN DEL SERVICIO DE SOPORTE TÉCNICO</h5>
            ...
            <div class="d-grid mx-auto col-6 col-md-5 col-lg-3">
